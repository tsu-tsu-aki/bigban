...
export default function HomeContact() {
  ...
  const inputClass =
    "w-full border-b-2 border-text-gray/40 bg-transparent py-3 text-text-light placeholder:text-text-gray/60 focus:border-accent focus:outline-none transition-colors";
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="bg-accent text-deep-black px-8 py-3 text-sm font-semibold tracking-[0.15em] uppercase hover:bg-accent/90 transition-colors disabled:opacity-50 uppercase"
              >
                SEND MESSAGE →
              </button>
