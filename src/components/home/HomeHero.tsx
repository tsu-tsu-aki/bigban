  ...
  return (
    <section className="relative min-h-screen bg-deep-black overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[10%] left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full blur-[200px]" style={{ background: 'rgba(48,110,195,0.1)' }} />
        <div className="absolute bottom-[20%] right-[10%] w-[400px] h-[400px] rounded-full blur-[150px]" style={{ background: 'rgba(17,49,123,0.08)' }} />
      </div>
