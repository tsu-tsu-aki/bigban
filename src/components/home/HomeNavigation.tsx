          ...
          >
            {NAV_ITEMS.map((item) => (
              <a
                key={item.id}
                href={item.href}
                className={`text-xs uppercase tracking-widest transition-colors hover:text-off-white ${
        ...
        {isMobileMenuOpen && (
          ...
          >
            <button
              ...
              className="absolute top-6 right-6 text-off-white"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              {NAV_ITEMS.map((item) => (
                <a
                  ...
                  className={`text-2xl uppercase tracking-widest transition-colors ${
                    activeSection === item.id ? "text-accent" : "text-off-white"
                  }`}
                >
                  {item.label}
                </a>
