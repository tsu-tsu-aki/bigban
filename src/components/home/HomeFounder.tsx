...
export default function HomeFounder() {
  return (
    <section
      ...
      style={{
        background: "linear-gradient(to bottom, #141210, #0C0C0C)",
      }}
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          {/* Left: name block + portrait */}
          <div className="lg:w-[40%] shrink-0">
            <motion.h2
              className="font-serif text-5xl lg:text-7xl text-off-white mb-4"
          ...
          <div className="flex-1">
            <ul className="space-y-4">
              {TIMELINE.map((entry, i) => (
                <motion.li
                  key={entry.text}
                  className="flex items-start gap-4 text-off-white/90 text-base lg:text-lg leading-relaxed"
        ...
        <div className="mt-20 border-t border-white/10 pt-12">
          ...
          <motion.p
            className="text-off-white/80 text-base lg:text-lg leading-relaxed mb-4 max-w-3xl"
