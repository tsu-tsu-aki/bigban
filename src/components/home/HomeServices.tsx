...
const SERVICES: ServiceItem[] = [
  {
    ...
    isReversed: false,
    isDark: true,
    moodText: "Court interior",
    image: "alex-saks-3k-yNMhYl5k-unsplash.jpg",
  },
  {
    number: "02",
    titleJa: "レッスン & クリニック",
    ...
    isReversed: true,
    isDark: false,
    moodText: "Pro coaching",
    image: "jon-matthews-usqfZcs_GfM-unsplash.jpg",
  },
  {
    number: "03",
    titleJa: "トレーニングプログラム",
    ...
    isReversed: false,
    isDark: true,
    moodText: "Training zone",
    image: "jon-matthews-q13YtbIPuv0-unsplash.jpg",
  },
  {
    number: "04",
    titleJa: "大会 & リーグ",
    ...
    isReversed: true,
    isDark: false,
    moodText: "Tournament day",
    image: "jon-matthews-1gOtJQQyN04-unsplash.jpg",
  },
  {
    number: "05",
    titleJa: "イベント",
    ...
    isDark: true,
    moodText: "Live event",
    image: "luxe-pickleball-VTKZwNXhaSc-unsplash.jpg",
  },
];
      ...
      {SERVICES.map((service, i) => (
        ...
        >
          ...
          >
            ...
            >
              <span className="font-serif text-7xl lg:text-[10rem] text-accent opacity-20 block mb-4">
                {service.number}
              </span>
